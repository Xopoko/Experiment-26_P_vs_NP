...
- [ ] **Q39 (Tseitin(Grid): depth gap for polynomial size in bounded-depth Frege):**
  ...
  - `NextStepID:` Q39.S153-oracle-xor-mapping-lemma
  - `LeanTarget:` formal/WIP/Verified/Q39.lean
  - `BarrierCheckRequired:` yes
  - `Lens:` Meta-reduction planning (exit plan).
  - `Artifact:` Reduction.
  ...
  - `Update:` Exit plan recorded in `docs/q39_s152.md`.
...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  ...
  - `NextStepID:` Q43.S359-band-log2-pit-mapping-lemma
  ...
  - `Lens:` Equivalence / translation (PIT/IPS mapping).
  - `Artifact:` Reduction.
  - `Update:` Reduction note recorded in `docs/q43_s358.md`.
