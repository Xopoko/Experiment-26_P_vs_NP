...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S134-s1-swap-compatibility (см. `formal/Notes/TseitinLocalEF.lean` §16.277)
  - `NextStepID:` Q43.S135-s1-use-audit
  - `LeanTarget:` formal/PvNP/Work.lean
  ...
  при $t'=(2s+1)\log M$ и допустимость замены $s_1=\log N$ на $s_1=\max\{\log N,t'\}$.
  Далее нужно найти (или исключить) место в Lemma 4.5, где $s_1=\log N$
  используется как равенство, а не как нижняя граница.
  Детали: `formal/Notes/TseitinLocalEF.lean` §16.191–§16.277.
