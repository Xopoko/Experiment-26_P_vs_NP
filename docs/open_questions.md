...
- [ ] **Q39 (Tseitin(Grid): закрыть разрыв по глубине для polynomial‑size):**
  ...
  Следующий шаг: перейти к XOR‑сложению граничных уравнений **двух соседних столбцов** как в HR’25 §1.2 и проверить, можно ли синхронизировать dyadic‑блоки на их общей полосе из $n$ рёбер так, чтобы шаг стал прямым «easy case» §16.130; иначе выделить минимальный row↔column переход, где неизбежно включается барьер §16.132.
