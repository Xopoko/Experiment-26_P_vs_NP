...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  ...
  - `NextStepID:` Q43.S295-gap-min-global-prune-klist-91-100
  ...
  - `Lens:` Automation/tactic engineering (trim decide-heavy k-blocks to keep automation tractable).
  - `Artifact:` Proof.
  - `Update:` pruned the unused k=81..90 gap-range/ratio-drop blocks.
  - `Use:` next: prune k=91..100 or consolidate the remaining k-list into a single uniform note.
