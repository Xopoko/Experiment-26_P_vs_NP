...
- [ ] **Q39 (Tseitin(Grid): закрыть разрыв по глубине для polynomial‑size):**
  ...
  Следующий шаг: зафиксировать точную формулировку representation‑факта HR’25 §1.2 (какая база/что считается глубиной/нужен ли выход $\\vee$) как «известную лемму», и затем вернуться к главному узлу Q39: синтаксическая симуляция XOR‑сложения (Gaussian elimination step) внутри bounded‑depth Frege.
