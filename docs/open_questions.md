...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  - `Priority:` P1
  - `Status:` ACTIVE
  - `LastStepID:` Q39.S14-2k-projection-rank-obstruction (см. `formal/Notes/TseitinQ39.lean` §16.160)
  ...
  Детали: `formal/Notes/TseitinQ39.lean` (§16.153–§16.159) и краткая сводка в `formal/Notes/TseitinLocalEF.lean` §16.187.
