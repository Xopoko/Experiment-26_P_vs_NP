...
- [ ] **Q39 (Tseitin(Grid): depth gap for polynomial size in bounded-depth Frege):**
  ...
  - `NextStepID:` Q39.S149-oracle-xor-step-stopreview
  ...
  - `Update:` Entropy Stopper STOP (pre-check); barrier note in `docs/q39_s148.md`.
...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  ...
  - `NextStepID:` Q43.S353-band-log2-stopper-review
  ...
  - `Artifact:` Proof.
  - `Update:` Entropy Stopper STOP (pre-check); barrier note in `docs/q43_s352.md`.
