...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  ...
  - `NextStepID:` Q39.S100-globalfixedpair-fixedorientation-contiguous-shift-alt13
  ...
  - `Update:` toy‑контрпример при $k=2$: следующий циклический alt‑shift
    ...
    (Q39_globalfixedpair_fixedorientation_contiguous_shift_alt12_vec1/vec2).
  - `Use:` следующий тест — следующий alt‑shift (alt13) для contiguous blocks.
  ...
  - `PublicSurface:` `formal/WIP/Work.lean` (Q39_rank2_globalfixedpair_fixedorientation_contiguous_shift_alt12)
