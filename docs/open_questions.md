...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  ...
  - `NextStepID:` Q43.S363-band-log2-predicate-refactor
  ...
  - `Lens:` Specification / definitions audit (constructivity definition).
  - `Artifact:` Barrier.
  - `Update:` Barrier certificate recorded in `docs/q43_s362.md`.
  - `Use:` next: refactor the predicate or mapping to avoid constructivity.
  - `BarrierCheck:` see `docs/q43_s359.md`; exit plan in `docs/q43_s360.md`.
  - `InfoGain:` 1.
    Details: `docs/q43_s362.md`.
