...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  - `Priority:` P1
  - `Status:` ACTIVE
  - `LastStepID:` Q39.S110-globalfixedpair-fixedorientation-contiguous-shift-alt23
  - `NextStepID:` Q39.S111-globalfixedpair-fixedorientation-contiguous-shift-alt24
  ...
  - `Update:` toy‑контрпример при $k=2$: очередной циклический alt‑shift
    ...
    (Q39_globalfixedpair_fixedorientation_contiguous_shift_alt23_vec1/vec2).
  - `Use:` следующий тест — следующий alt‑shift (alt24) для contiguous blocks.
  ...
  - `PublicSurface:` `formal/WIP/Work.lean` (Q39_rank2_globalfixedpair_fixedorientation_contiguous_shift_alt23)
