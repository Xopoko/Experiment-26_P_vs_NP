...
- [ ] **Q39 (Tseitin(Grid): depth gap for polynomial size in bounded-depth Frege):**
  ...
  - `Priority:` P1
  - `Status:` BLOCKED
  - `LastStepID:` Q39.S165-globalfixedpair-fixedorientation-contiguous-shift-alt78
  - `NextStepID:` Q39.S166-globalfixedpair-fixedorientation-contiguous-shift-alt79
  ...
  - `Attempts:` 21
  - `LastOutcome:` BLOCKED (entropy-stopper pre-check exit 42, score 5.1; doc `docs/q39_s165.md` records the pause and queues `Q39.S166-globalfixedpair-fixedorientation-contiguous-shift-alt79`)
  - `BlockerType:` BARRIER_ENTROPY
  - `TimeBudget:` 2h
  - `Deps:` `formal/WIP/Verified/Q39.lean`, `scripts/toy_q39_rank2.py`
  - `DefinitionOfDone:` wait for the entropy-stopper policy to return `CONTINUE`, inspect the gadget support guard as described in `docs/q39_s163.md`, and reissue the audit once the score drops (follow-up Step: `Q39.S166-globalfixedpair-fixedorientation-contiguous-shift-alt79`).
  - `Update:` Barrier notes recorded in `docs/q39_s158.md`, `docs/q39_s159.md`, `docs/q39_s161.md`, and `docs/q39_s162.md`; `docs/q39_s163.md`/`docs/q39_s164.md`/`docs/q39_s165.md` now record the entropy STOP and queue the retry step.
  - `PublicSurface:` `scripts/toy_q39_rank2.py`, `formal/WIP/Verified/Q39.lean`, `docs/q39_s158.md`, `docs/q39_s159.md`, `docs/q39_s160.md`, `docs/q39_s161.md`, `docs/q39_s162.md`, `docs/q39_s163.md`, `docs/q39_s165.md`
  ...
  - `Success:` `scripts/stopper_advice.py --mode pre` returned `STOP` (score 5.1) so the gadget support audit could not start; `docs/q39_s165.md` records the blockage and the retry step `Q39.S166-globalfixedpair-fixedorientation-contiguous-shift-alt79`.
...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):
  ...
  - `Priority:` P0
  - `Status:` BLOCKED
  - `LastStepID:` Q43.S379-nonuniform-support-witness-finalize8
  - `NextStepID:` Q43.S380-nonuniform-support-witness-finalize9
  ...
  - `Attempts:` 37
  - `LastOutcome:` BLOCKED (entropy-stopper pre-check exit 42, score 6.7; doc `docs/q43_s379.md` records the pause and queues `Q43.S380-nonuniform-support-witness-finalize9`)
  - `BlockerType:` BARRIER_ENTROPY
  - `TimeBudget:` 2h
  - `Deps:` `formal/WIP/Verified/Q43.lean`, `scripts/toy_q43_gap_sqrt2.py`, `docs/q43_s372.md`, `docs/q43_s373.md`, `docs/q43_s374.md`, `docs/q43_s375.md`, `docs/q43_s376.md`, `docs/q43_s377.md`, `docs/q43_s378.md`, `docs/q43_s379.md`
  - `DefinitionOfDone:` once the entropy-stopper policy returns `CONTINUE`, formalize the per-instance advice witness layout (follow-up Step: `Q43.S380-nonuniform-support-witness-finalize9`).
  ...
  - `PublicSurface:` `formal/WIP/Verified/Q43.lean`
    ...
    `docs/q43_s378.md`
    `docs/q43_s379.md`
  - `Success:` entropy-stopper pre-check returned `STOP` (score 6.7) before the witness layout could be completed; `docs/q43_s379.md` now records the blockage and schedules `Q43.S380-nonuniform-support-witness-finalize9`.
  - `Lens:` Barrier-driven design (entropy barrier).
  - `Artifact:` Barrier.
  - `Update:` `docs/q43_s379.md` logs the entropy STOP (score 6.7) and queues the retry step.
  - `Use:` next: wait for the entropy policy to lower the score and then formalize the layout in `Q43.S380-nonuniform-support-witness-finalize9`.
  - `BarrierCheck:`
    - `Relativization:`
      - Relativizes?: unknown
