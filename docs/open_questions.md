...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S79-symmetry-counterexample (см. `docs/research/16_tseitin_local_ef.md` §16.234)
  - `NextStepID:` Q43.S80-chirality-bit
  ...
  симметри‑ломающий маркер) к подписи для фиксации ориентации без identity‑leak
  (Q43.S80-chirality-bit); иначе вернуться к основному треку Q43.
