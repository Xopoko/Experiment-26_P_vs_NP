...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S78-orientation-explicit-quote (см. `docs/research/16_tseitin_local_ef.md` §16.233)
  - `NextStepID:` Q43.S76-anchor-canonicalization
  ...
  иначе вернуться к основному треку Q43.
