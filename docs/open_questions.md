...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  ...
  - `NextStepID:` Q43.S291-gap-min-global-prune-klist-51-60
  ...
  - `Artifact:` Proof.
  - `Update:` pruned the unused k=41..50 gap-range/ratio-drop blocks.
  - `Use:` next: prune k=51..60 or consolidate the remaining k-list into a single uniform note.
