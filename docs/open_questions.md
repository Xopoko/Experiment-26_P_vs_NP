...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  - `Priority:` P1
  - `Status:` ACTIVE
  - `LastStepID:` Q39.S108-globalfixedpair-fixedorientation-contiguous-shift-alt21
  - `NextStepID:` Q39.S109-globalfixedpair-fixedorientation-contiguous-shift-alt22
  ...
  - `Update:` toy‑контрпример при $k=2$: очередной циклический alt‑shift
    ...
    (Q39_globalfixedpair_fixedorientation_contiguous_shift_alt21_vec1/vec2).
  - `Use:` следующий тест — следующий alt‑shift (alt22) для contiguous blocks.
  ...
  - `PublicSurface:` `formal/WIP/Work.lean` (Q39_rank2_globalfixedpair_fixedorientation_contiguous_shift_alt21)
