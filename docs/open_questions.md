...
- [ ] **Q39 (Tseitin(Grid): закрыть разрыв по глубине для polynomial‑size):**
  ...
  Следующий шаг: на toy‑уровне взять HR‑представители PARITY/$\\neg$PARITY на одном блоке и попробовать вывести в bounded‑depth Frege poly‑size эквивалентность $N\\leftrightarrow\\neg P$ без выхода за глубину $d$ (или зафиксировать точную причину quasi‑poly blow‑up); это нужно, чтобы превращать representation из §1.2 в реальные Cut/merge‑шаги.
