...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S31-critical-depth-kappa (см. `docs/research/16_tseitin.md` §16.198)
  - `NextStepID:` Q43.S32-m-factor-ell-constant
  ...
  `Барьер‑чек:` r — применимо, NP — неприменимо, alg — неприменимо.
  Следующий шаг: оценить вклад фактора $M^{s/\\ell}$ при выборе $\\ell:=t'=(2s+1)\\log M$ и понять, действительно ли он $\\exp(\\Theta(1))$.
