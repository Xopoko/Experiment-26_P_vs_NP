...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  - `Priority:` P1
  - `Status:` ACTIVE
  - `LastStepID:` Q39.S96-globalfixedpair-fixedorientation-contiguous-shift-alt9
  - `NextStepID:` Q39.S97-globalfixedpair-fixedorientation-contiguous-shift-alt10
  ...
  - `Update:` toy‑контрпример при $k=2$: следующий циклический alt‑shift
    ...
    (Q39_globalfixedpair_fixedorientation_contiguous_shift_alt9_vec1/vec2).
  - `Use:` следующий тест — следующий alt‑shift (alt10) для contiguous blocks.
  ...
  - `PublicSurface:` `formal/WIP/Work.lean` (Q39_rank2_globalfixedpair_fixedorientation_contiguous_shift_alt9)
