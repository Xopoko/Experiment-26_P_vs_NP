...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S318-flat-eval-quasipoly-hr-threshold-plateau-lift
  - `NextStepID:` Q43.S319-flat-eval-quasipoly-hr-threshold-upper-plateau-lift
  ...
  - `Lens:` Invariant (plateau monotonicity of grid_ratio).
  - `Artifact:` Proof.
  - `Update:` lifted ratio bounds from 2^k across the lower plateau and used it to
    re-prove the toy n0 bound; see `docs/q43_s318.md`.
  - `Use:` next: extend the lift to the upper plateau or the gap interval for explicit n0(c).
