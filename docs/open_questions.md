...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S115-quotient-parity-criterion (см. `docs/research/16_tseitin_local_ef.md` §16.261)
  - `NextStepID:` Q43.S116-overlapping-stars-counterexample
  ...
  (lxviii) доказано: в каноническом режиме система $A x=\\mathbf 1$ эквивалентна
  ...
  `Барьер‑чек:` r — применимо, NP — неприменимо, alg — неприменимо.
  Следующий шаг: стресс‑тестировать критерий вне канонического режима (overlapping π‑звёзды
  или chosen–non‑chosen edge) и попытаться найти контрпример (Q43.S116).
