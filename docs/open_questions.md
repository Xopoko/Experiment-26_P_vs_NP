...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S106-pi-quotient-rank-lemma (см. `docs/research/16_tseitin_local_ef.md` §16.254)
  - `NextStepID:` Q43.S107-pi-quotient-counterexample-def6-2-4
  ...
  `Барьер‑чек:` r — применимо, NP — неприменимо, alg — неприменимо.
  Следующий шаг: найти (или исключить) пример, где $\\beta(G/\\pi)=1$, но Def. 6.2(4)
  запрещает все closed $I$ (Q43.S107).
