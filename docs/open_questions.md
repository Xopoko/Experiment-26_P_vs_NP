...
- [ ] **Q39 (Tseitin(Grid): depth‑gap для polynomial‑size в bounded‑depth Frege):**
  ...
  - `NextStepID:` Q39.S92-globalfixedpair-fixedorientation-contiguous-shift-alt5
  ...
  - `Update:` toy‑контрпример при $k=2$: ещё один alt‑shift
    ...
    (Q39_globalfixedpair_fixedorientation_contiguous_shift_alt4_vec1/vec2).
  - `Use:` следующий тест — следующий alt‑shift (alt5) для contiguous blocks.
  ...
  - `PublicSurface:` `formal/WIP/Work.lean` (Q39_rank2_globalfixedpair_fixedorientation_contiguous_shift_alt4)
