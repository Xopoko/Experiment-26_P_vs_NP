...
- [ ] **Q43 (flat local‑EF(s): существуют ли “малые” evaluations для poly‑size доказательств?):**
  - `Priority:` P0
  - `Status:` ACTIVE
  - `LastStepID:` Q43.S74-dir-rule-chord-bits (см. `docs/research/16_tseitin_local_ef.md` §16.231)
  - `NextStepID:` Q43.S75-orientation-leak-check
  ...
  `Барьер‑чек:` r — применимо, NP — неприменимо, alg — неприменимо.
  Следующий шаг: проверить, не требует ли фиксированная ориентация grid явного якоря
  и нет ли identity‑leak при симметриях (Q43.S75-orientation-leak-check).
