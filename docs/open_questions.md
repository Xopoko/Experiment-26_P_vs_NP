...
- [ ] **Q43 (flat local-EF(s): are there "small" evaluations for poly-size proofs?):
  ...
  - `NextStepID:` Q43.S374-nonuniform-support-witness-finalize3
  ...
  - `Attempts:` 31
  - `LastOutcome:` BLOCKED (entropy-stopper pre-check exit 42, score 4.2; doc `docs/q43_s373.md` records the pause and queues `Q43.S374-nonuniform-support-witness-finalize3`)
  - `BlockerType:` BARRIER_ENTROPY
  - `TimeBudget:` 2h
  - `Deps:` `formal/WIP/Verified/Q43.lean`, `scripts/toy_q43_gap_sqrt2.py`, `docs/q43_s372.md`, `docs/q43_s373.md`
  - `DefinitionOfDone:` once the entropy-stopper policy returns `CONTINUE`, formalize the per-instance advice witness layout (follow-up Step: `Q43.S374-nonuniform-support-witness-finalize3`).
  ...
  - `PublicSurface:` `formal/WIP/Verified/Q43.lean`
    ...
    `docs/q43_s372.md`
    `docs/q43_s373.md`
  - `Success:` entropy-stopper pre-check returned `STOP` (score 4.2) before the witness layout could be completed; `docs/q43_s373.md` now records the blockage and schedules `Q43.S374-nonuniform-support-witness-finalize3`.
  - `Lens:` Model stress test (entropy/oracle cooldown).
  - `Artifact:` Barrier.
  - `Update:` `docs/q43_s373.md` logs the entropy STOP (score 4.2) and queues the retry step.
  - `Use:` next: wait for the entropy policy to lower the score and then formalize the layout in `Q43.S374-nonuniform-support-witness-finalize3`.
  - `BarrierCheck:`
    - `Relativization:`
      - Relativizes?: unknown
