...
- `LastStepID:` Q39.S11-xortree-projection-general
- `Do-not-repeat (next 2 runs):` Q39.S11-xortree-projection-general, Q43.S113-beta0-counterexample
- `Last InfoGain:` 1
...
Q39: XOR‑дерево для $\\delta(B_{t+1,t+2})$ всегда режет фиксированный 2‑строчный блок;
следующий шаг — проверить even‑batching по $2k$ строкам.
...
Последние:Инв→МодСтресс→Инв→Комм/Ранг→Инв
