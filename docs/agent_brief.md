...
- `Do-not-repeat (next 2 runs):` Q43.S174-exp2-threshold-sweep, Q43.S175-exp2-quote-annotation
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: пометки base‑2 добавлены к цитатам с `exp`; следующий шаг — согласовать такие пометы в других разделах.
...
Последние:Трейд‑офф→Эквивалентность→Эквивалентность→Сжатие/канонизация→Эквивалентность
