...
- `Do-not-repeat (next 2 runs):` Q43.S171-check-thm41-threshold, Q43.S172-exp2-consistency
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: $\\exp$ унифицирован как $2^x$; следующий шаг — пересчитать $c_1,c_2$ и пороги в базе $2$.
...
- Q43 из `docs/open_questions.md` (пересчитать $c_1,c_2$ и пороги $M>\\exp(n^\\alpha)$ в базе $2$).
...
Последние:Трейд‑офф→Инвариант→Эквивалентность→Трейд‑офф→Эквивалентность
