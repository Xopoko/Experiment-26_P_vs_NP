...
- `Do-not-repeat (next 2 runs):` Q43.S173-exp2-c1c2-rescale, Q43.S174-exp2-threshold-sweep
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: $\\exp$‑пороги приведены к $2^{(\\cdot)}$; следующий шаг — пометить цитаты источников про base‑2.
...
- Q43 из `docs/open_questions.md` (пройти цитаты и отметить base‑2 интерпретацию `exp`).
...
Последние:Эквивалентность→Трейд‑офф→Эквивалентность→Эквивалентность→Сжатие/канонизация
