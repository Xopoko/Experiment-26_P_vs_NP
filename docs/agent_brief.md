...
- `Do-not-repeat (next 2 runs):` Q43.S158-largem-branch-polym-check, Q43.S159-thm41-bound-translate
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: перевод Thm. 4.1 в $|F|$ при $\\kappa=59$ даёт субполиномиальный bound ($\\exp=e^x$).
Следующий шаг — попробовать извлечь явные константы из Lemma 4.2/Proof Thm. 4.1.
...
- Q43 из `docs/open_questions.md` (извлечь явные константы для Thm. 4.1 или зафиксировать барьер).
...
Последние:Инвариант→Эквивалентность→Трейд‑офф→Эквивалентность→Трейд‑офф
