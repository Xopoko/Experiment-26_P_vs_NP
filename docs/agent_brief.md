...
- `Do-not-repeat (next 2 runs):` Q43.S155-lemma69-constant-extract, Q43.S156-lemma69-recount-needed
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: для явного $A$ нужен полный пересчёт Lemma 6.9; барьер закреплён.
Следующий шаг — pivot к Håstad’20 (явный режим) или план пересчёта.
...
- Q43 из `docs/open_questions.md` (перейти к Håstad’20 Thm. 6.5 или планировать пересчёт).
...
Последние:Инвариант→Инвариант→Эквивалентность→Инвариант→Эквивалентность
