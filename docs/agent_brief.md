...
- `Do-not-repeat (next 2 runs):` Q43.S170-explicit-c1c2-thm41, Q43.S171-check-thm41-threshold
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: база $\\log=2$ зафиксирована; следующий шаг — привести пороги $M>\\exp(n^\\alpha)$ к базе $2$.
...
- Q43 из `docs/open_questions.md` (привести пороги $M>\\exp(n^\\alpha)$ к базе $2$ и согласовать $c_1,c_2$).
