...
- `LastStepID:` Q43.S56-generalize-a1-per-center
- `Do-not-repeat (next 2 runs):` Q43.S56-generalize-a1-per-center, Q43.S55-count-a1-per-center
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑подсчёт для $|S^{*}_g|=3$ (2 chosen + 1 non‑chosen) даёт ≤49 конст. бит и
согласуется с $A_1=18$ на центр; нужен общий per‑center инвариант для явного $A_1$.
