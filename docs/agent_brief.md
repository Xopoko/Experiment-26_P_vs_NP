...
- `LastStepID:` Q39.S33-2k-two-strip-single-row-change
- `Do-not-repeat (next 2 runs):` Q39.S32-2k-two-strip-alternating-strip, Q39.S33-2k-two-strip-single-row-change
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: одно‑строчное изменение на полосах не снижает ранг; следующий шаг — ламинарность по строкам.
