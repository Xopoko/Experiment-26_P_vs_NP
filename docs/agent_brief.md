...
- `LastStepID:` Q43.S110-decouple-even-pi
- `Do-not-repeat (next 2 runs):` Q43.S110-decouple-even-pi, Q43.S109-two-pi-components-rank
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑тест с π‑звездой размера 4 и π‑ребром совместим с запретом chosen–non‑chosen;
следующий шаг — проверить две π‑звезды размера 4 на возможную несовместимость.
...
Последние:Мод→Инв→Инв→Комм/Ранг→Инв
