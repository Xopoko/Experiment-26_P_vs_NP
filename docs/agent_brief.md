...
- `Do-not-repeat (next 2 runs):` Q43.S146-kappa-constant-source, Q43.S147-apply-thm41-branch
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: при $\\kappa=59$ poly‑$M$ попадает в large‑$M$ ветку; следующий шаг — проверить,
где Proof of Thm. 4.3 реально требует ветку Thm. 4.1.
...
- Q43 из `docs/open_questions.md` (audit ветки Thm. 4.1 в Proof of Thm. 4.3 для poly‑$M$).
...
Последние:Эквивалентность→Трейд‑офф→Инвариант→Инвариант→Трейд‑офф
