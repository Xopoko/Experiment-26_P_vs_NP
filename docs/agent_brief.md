...
- `Do-not-repeat (next 2 runs):` Q43.S147-apply-thm41-branch, Q43.S148-thm41-branch-audit
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: Proof of Thm. 4.3 явно отправляет $M$ выше порога в Thm. 4.1; следующий шаг —
выписать явный bound Thm. 4.1 для $M=\\mathrm{poly}(|F|)$.
...
- Q43 из `docs/open_questions.md` (явный large‑$M$ bound из Thm. 4.1 для poly‑$M$).
...
Последние:Трейд‑офф→Инвариант→Инвариант→Трейд‑офф→Инвариант
