...
- `LastStepID:` Q39.S116-globalfixedpair-fixedorientation-contiguous-shift-alt29
- `Do-not-repeat (next 2 runs):` Q39.S116-globalfixedpair-fixedorientation-contiguous-shift-alt29, Q43.S246-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound-apply-params-poly-n0-ratio-lift-piecewise-intervals
- `Last InfoGain:` 1
...
Последние:Коммуникация/ранг→Эквивалентность→Коммуникация/ранг→Коммуникация/ранг→Коммуникация/ранг
