...
- `LastStepID:` Q43.S80-chirality-bit
- `Do-not-repeat (next 2 runs):` Q43.S80-chirality-bit, Q43.S79-symmetry-counterexample
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: глобальный chirality‑бит, инвариантный без identity, не ломает симметрию (крест/2×2);
следующий шаг — проверить, допустим ли внешний advice‑бит ориентации без identity‑leak.
