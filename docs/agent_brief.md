...
- `LastStepID:` Q43.S121-mixed-edge-quotient-linear-criterion
- `Do-not-repeat (next 2 runs):` Q43.S120-even-mixed-edge-counterexample, Q43.S121-mixed-edge-quotient-linear-criterion
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑проверка показывает, что критерий на квотиенте с сохранением chosen‑вершин
отсекает mixed‑edge контрпример; следующий шаг — доказать эквивалентность или
найти контрпример к этому критерию.
