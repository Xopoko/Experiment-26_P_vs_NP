...
- `LastStepID:` Q39.S52-2k-two-strip-chain-strip-support-rowcol-2d-prefix
- `Do-not-repeat (next 2 runs):` Q39.S51-2k-two-strip-chain-strip-support-rowcol-nested, Q39.S52-2k-two-strip-chain-strip-support-rowcol-2d-prefix
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: pivot на размер развёрнутых формул; следующий шаг — ограничить |φ_i| или обойти развёртывание.
Q39: 2D‑prefix цепочка всё равно даёт ранг 2; следующий шаг — микрошаги без пропусков.
...
- Q39 из `docs/open_questions.md` (проверить 2D‑prefix микрошаги для XOR‑шага).
