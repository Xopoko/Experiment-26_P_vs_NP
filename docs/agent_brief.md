...
- `LastStepID:` Q39.S32-2k-two-strip-alternating-strip
- `Do-not-repeat (next 2 runs):` Q39.S31-2k-two-strip-prefix-chain, Q39.S32-2k-two-strip-alternating-strip
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: чередование полос в XOR‑шаге не снижает ранг; следующий шаг — одно‑строчное изменение.
