...
- `LastStepID:` Q43.S139-polym-avoids-thm41-branch
- `Do-not-repeat (next 2 runs):` Q39.S36-2k-two-strip-equal-rows-single-change, Q43.S139-polym-avoids-thm41-branch
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: добавлена монотонность IsPoly; следующий шаг — связать poly‑$M$ с порогом large‑$M$.
Q39: равные строки + одно‑строчное изменение не снижают ранг; следующий шаг — цепочка по строкам.
...
Последние:Инвариант→Трейд‑офф→Коммуникация/ранг→Инвариант→Трейд‑офф
