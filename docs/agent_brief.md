...
- `Do-not-repeat (next 2 runs):` Q39.S95-globalfixedpair-fixedorientation-contiguous-shift-alt8, Q43.S232-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound-apply-params-poly-compare
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: доказано $\\log_2(|F|^C)\\le (\\log_2|F|+1)C$; следующий шаг — при $n\\ge 2$ заменить $\\log_2|F|+1\\le 2\\log_2|F|$ и сравнить $2C\\,c_1\\log_2^5|F|$ с $|F|$.
Q39: alt8‑shift для contiguous blocks при fixed‑orientation всё ещё даёт ранг 2; следующий шаг — alt9‑shift.
...
- Q43 из `docs/open_questions.md` (сравнить $2C\\,c_1\\log_2^5|F|$ с $|F|$).
