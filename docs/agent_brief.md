...
- `LastStepID:` Q39.S18-2k-staircase-geometry-obstruction
- `Do-not-repeat (next 2 runs):` Q39.S18-2k-staircase-geometry-obstruction, Q39.S17-2k-rectangular-geometry-obstruction
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: показано $n_0(668)=2$, поэтому $n\\ge n_0(A)$ избыточно при $n\\ge 20 C n'\\log n'$;
следующий шаг — обновить сводку ограничений HR‑режима.
Q39: контрпример: даже при anchored‑staircase (префикс‑по‑строкам) геометрии внутренних узлов
проекционный ранг остаётся 2 при $k=2$; следующий шаг — усилить геометрию (короткий фронтир).
...
Последние:Комм/ранг→Инв→МодСтресс→Инв→МодСтресс
