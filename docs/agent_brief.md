...
- `LastStepID:` Q39.S12-evenbatch-2k-counterexample
- `Do-not-repeat (next 2 runs):` Q39.S12-evenbatch-2k-counterexample, Q39.S11-xortree-projection-general
- `Last InfoGain:` 1
...
Последние:МодСтресс→Инв→МодСтресс→Инв→Комм/Ранг
