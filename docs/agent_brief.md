...
- `Do-not-repeat (next 2 runs):` Q39.S138-globalfixedpair-fixedorientation-contiguous-shift-alt51, Q43.S268-nk-sqrt-bounds
- `Last InfoGain:` 1

## Current direction (keep 1-2 lines)

Q43: isqrt floor bound cited; next is to define floor-sqrt in Lean and connect to n_k.
Q39: alt51shift for contiguous blocks with fixedorientation still gives rank 2; the next step is alt52shift.
...
Latest:Communication/Rank->Equivalence->Communication/Rank->Invariant->Communication/Rank
