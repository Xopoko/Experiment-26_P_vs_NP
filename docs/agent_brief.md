...
- `Do-not-repeat (next 2 runs):` Q43.S185-exp2-quote-scan-logbases-summary-final, Q43.S186-exp2-quote-scan-logbases-summary-tail
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в summary `docs/12_time_hierarchy.md` лог‑база приведена к $\\log_2$; следующий шаг — проверить остаточные $\\log$ в summary.
