...
- `Do-not-repeat (next 2 runs):` Q43.S172-exp2-consistency, Q43.S173-exp2-c1c2-rescale
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: $c_1,c_2$ согласованы с $\\exp_2$; следующий шаг — пройти Q43 и заменить $\\exp(\\cdot)$ на $2^{(\\cdot)}$.
...
- Q43 из `docs/open_questions.md` (пройти Q43 и заменить $\\exp(\\cdot)$ на $2^{(\\cdot)}$ в единой базе).
...
Последние:Инвариант→Эквивалентность→Трейд‑офф→Эквивалентность→Эквивалентность
