...
- `Do-not-repeat (next 2 runs):` Q43.S149-largem-bound-from-thm41, Q43.S150-thm41-bound-compare
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в poly‑режиме bound Thm. 4.1 тривиален при $\\kappa=59$; следующий шаг —
проверить, есть ли реалистичный режим глубины с $\\kappa<1/5$ (или иной масштаб $d$).
...
- Q43 из `docs/open_questions.md` (поиск режима, где Thm. 4.1 даёт сверхполиномиальность).
...
Последние:Инвариант→Трейд‑офф→Инвариант→Эквивалентность→Трейд‑офф
