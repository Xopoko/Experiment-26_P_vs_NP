...
- `Do-not-repeat (next 2 runs):` Q43.S197-flat-eval-size-metric-tparam, Q43.S198-flat-eval-tparam-usage
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: t привязан к proofSize; следующий шаг — оформить t=O(log S) или t=O(log n) режим.
...
- Q43 из `docs/open_questions.md` (оформить t=O(log S) и использовать в Q43).
...
Последние:Инвариант→Сжатие/канонизация→Инвариант→Эквивалентность→Эквивалентность
