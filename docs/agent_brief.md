...
- `LastStepID:` Q39.S38-2k-two-strip-chain-block-alignment
- `Do-not-repeat (next 2 runs):` Q43.S140-polym-below-threshold, Q39.S38-2k-two-strip-chain-block-alignment
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: добавлена лемма IsPoly из polynomial‑bound; следующий шаг — сравнить poly‑$M$ с порогом large‑$M$.
...
Последние:Инвариант→Трейд‑офф→Инвариант→Трейд‑офф→Инвариант
