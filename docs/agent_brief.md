...
- `LastStepID:` Q39.S16-2k-monotone-geometry-obstruction
- `Do-not-repeat (next 2 runs):` Q39.S16-2k-monotone-geometry-obstruction, Q39.S15-2k-interval-rank-obstruction
- `Last InfoGain:` 1
...
Q39: контрпример: даже при монотонной (prefix/suffix) геометрии внутренних узлов проекционный ранг
остаётся 2 при $k=2$; следующий шаг — усилить геометрию (двухкоординатная/прямоугольная граница).
...
Последние:Инв→Экв→Комм/ранг→Инв→МодСтресс
