...
- `Do-not-repeat (next 2 runs):` Q39.S53-2k-two-strip-chain-strip-support-rowcol-2d-prefix-microsteps, Q43.S192-flat-eval-axiom-size-bound
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: axiom-size bound сводится к размеру строк; следующий шаг — проверить учёт extension-аксиом в метрике.
Q39: 2D‑prefix микрошаги всё равно дают ранг 2; следующий шаг — lock‑step по строкам+колонкам.
...
- Q39 из `docs/open_questions.md` (проверить lock‑step по строкам+колонкам для XOR‑шага).
- Q43 из `docs/open_questions.md` (проверить учёт размера extension‑аксиом в модели).
...
Последние:Инвариант→Коммуникация/ранг→Инвариант→Инвариант→Трейд-офф
