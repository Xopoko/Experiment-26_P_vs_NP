...
- `LastStepID:` Q39.S15-2k-interval-rank-obstruction
- `Do-not-repeat (next 2 runs):` Q39.S15-2k-interval-rank-obstruction, Q39.S14-2k-projection-rank-obstruction
- `Last InfoGain:` 1
...
Q39: контрпример: даже при row‑interval геометрии внутренних узлов проекционный ранг остаётся 2
при $k=2$; следующий шаг — усилить геометрию (монотонная/связная граница).
...
Последние:МодСтресс→Инв→Экв→Комм/ранг→Инв
