...
- `LastStepID:` Q39.S31-2k-two-strip-prefix-chain
- `Do-not-repeat (next 2 runs):` Q39.S30-2k-two-strip-anchored-rectangles, Q39.S31-2k-two-strip-prefix-chain
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: prefix-цепочка anchored-прямоугольников не снижает ранг; следующий шаг — чередование полос.
...
Последние:Коммуникация/ранг→Инвариант→Коммуникация/ранг→Инвариант→Трейд‑офф
