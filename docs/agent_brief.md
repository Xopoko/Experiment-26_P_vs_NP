...
- `Do-not-repeat (next 2 runs):` Q39.S47-2k-two-strip-chain-strip-support-global-schedule, Q43.S191-flat-eval-construction-pivot
- `Last InfoGain:` 1
...
Последние:Эквивалентность→Инвариант→Эквивалентность→Коммуникация/ранг→Трейд‑офф
