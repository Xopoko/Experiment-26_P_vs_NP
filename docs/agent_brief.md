...
- `LastStepID:` Q43.S138-logn-nonimpact-check
- `Do-not-repeat (next 2 runs):` Q43.S138-logn-nonimpact-check, Q39.S26-2k-two-strip-frontier-adj
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: фронтир‑ребро = ребро графа (symm); следующий шаг — interval rank bound.
