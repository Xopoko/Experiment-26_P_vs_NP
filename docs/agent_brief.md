...
- `Do-not-repeat (next 2 runs):` Q43.S246-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound-apply-params-poly-n0-ratio-lift-piecewise-intervals, Q39.S115-globalfixedpair-fixedorientation-contiguous-shift-alt28
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: плато‑лемма (log2|F|=2k) для n в под‑интервале; дальше — применить к lift порога по интервалам.
Q39: alt28‑shift для contiguous blocks при fixed‑orientation всё ещё даёт ранг 2; следующий шаг — alt29‑shift.
...
Последние:Эквивалентность→Коммуникация/ранг→Коммуникация/ранг→Коммуникация/ранг→Эквивалентность
