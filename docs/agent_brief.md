...
- `Do-not-repeat (next 2 runs):` Q43.S186-exp2-quote-scan-logbases-summary-tail, Q43.S187-exp2-quote-scan-logbases-summary-audit
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в summary `docs/09_circuit_complexity.md` лог‑база согласована как $\\ln$; следующий шаг — закрыть аудит лог‑баз в summary.
...
Последние:Сжатие/канонизация→Эквивалентность→Сжатие/канонизация→Эквивалентность→Эквивалентность
