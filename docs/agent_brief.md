...
- `LastStepID:` Q43.S146-kappa-constant-source
- `Do-not-repeat (next 2 runs):` Q43.S145-kappa-regime-decision, Q43.S146-kappa-constant-source
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: закреплён источник $\\kappa=59$ (Håstad’20 Thm. 6.5); следующий шаг — применить ветку Thm. 4.1.
...
Последние:Трейд‑офф→Эквивалентность→Трейд‑офф→Инвариант→Инвариант
