...
- `Do-not-repeat (next 2 runs):` Q43.S195-flat-eval-axiom-size-definition, Q43.S196-flat-eval-size-metric-formalize
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: метрика размера формализована в Lean; следующий шаг — связать $t=\log_2 M$ в Q43.
...
- Q43 из `docs/open_questions.md` (связать параметры $(N,M)$ с $t=\log_2 M$).
...
Последние:Трейд-офф→Эквивалентность→Инвариант→Сжатие/канонизация→Инвариант
