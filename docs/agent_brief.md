...
- `LastStepID:` Q43.S68-tree-uniqueness-cycle-bit
- `Do-not-repeat (next 2 runs):` Q43.S68-tree-uniqueness-cycle-bit, Q43.S64-absorb-a2-by-signature
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: неоднозначность $I_j$ равна выбору по циклам (odd‑degree подграфы); дальше проверить,
можно ли кодировать базис циклов $O(1)$ битами на центр без ухудшения оценки.
