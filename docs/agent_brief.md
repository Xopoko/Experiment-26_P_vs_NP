...
- `Do-not-repeat (next 2 runs):` Q39.S66-2k-two-strip-chain-strip-support-rowcol-2d-prefix-global-order-microsteps-alternating-bothstrips-local-block-monotone-2d, Q43.S206-flat-eval-hr-neta-range
- `Last InfoGain:` 1
...
Последние:Коммуникация/ранг→Коммуникация/ранг→Инвариант→Коммуникация/ранг→Инвариант
