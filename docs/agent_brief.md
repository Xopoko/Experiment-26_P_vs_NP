...
- `LastStepID:` Q39.S14-2k-projection-rank-obstruction
- `Do-not-repeat (next 2 runs):` Q43.S131-compare-n0-a, Q39.S14-2k-projection-rank-obstruction
- `Last InfoGain:` 1
...
Q39: контрпример: ранговая обструкция «rank$\\le 1$» не работает уже при $k=2$ даже при
$\\pi$‑совместимых внутренних узлах; следующий шаг — усилить инвариант геометрией подмножеств.
...
Последние:Инв→МодСтресс→Инв→Экв→Комм/ранг
