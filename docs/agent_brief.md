...
- `LastStepID:` Q43.S142-parameter-map-n-vs-bign
- `Do-not-repeat (next 2 runs):` Q43.S141-poly-vs-exp-threshold, Q43.S142-parameter-map-n-vs-bign
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: зафиксировано, что $n$ — сторона грида, $N$ — длина доказательства, $\\exp=e^x$; следующий шаг — переписать порог в терминах $N$/$|F|$.
