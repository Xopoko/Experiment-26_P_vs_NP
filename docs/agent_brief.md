...
- `Do-not-repeat (next 2 runs):` Q43.S181-exp2-quote-scan-logbases-remaining, Q43.S182-exp2-quote-scan-logbases-core-sweep
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в core/summary лог‑база в экспонентах приведена к $\\log_2$; следующий шаг — добить оставшиеся $\\log$ в summary вне Q43‑блоков.
...
Последние:Сжатие/канонизация→Трейд‑офф→Эквивалентность→Сжатие/канонизация→Эквивалентность
