...
- `Do-not-repeat (next 2 runs):` Q43.S154-lemma42-constants-extract, Q43.S155-lemma69-constant-extract
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: Proof of Lemma 6.9 использует “constant number of bits” и $A|S^*_g|$ без чисел;
следующий шаг — решить, делать ли полный пересчёт или закрепить барьер.
...
- Q43 из `docs/open_questions.md` (решить: полный пересчёт Proof of Lemma 6.9 или фиксировать барьер).
...
Последние:Инвариант→Эквивалентность→Инвариант→Эквивалентность→Инвариант
