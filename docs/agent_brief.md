...
- `LastStepID:` Q43.S87-fixed-center-parity
- `Do-not-repeat (next 2 runs):` Q43.S86-admissible-d4-support, Q43.S87-fixed-center-parity
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: доказано, что closed D4‑support с фикс‑центром невозможен (odd‑degree ⇒ |supp| чётно),
следующий шаг — проверить D4‑support без фикс‑центра (орбиты 4/8).
