...
- `LastStepID:` Q43.S140-polym-below-threshold
- `Do-not-repeat (next 2 runs):` Q39.S37-2k-two-strip-equal-rows-single-change-chain, Q43.S140-polym-below-threshold
- `Last InfoGain:` 1
...
Последние:Коммуникация/ранг→Инвариант→Трейд‑офф→Инвариант→Трейд‑офф
