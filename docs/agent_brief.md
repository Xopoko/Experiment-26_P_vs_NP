...
- `LastStepID:` Q43.S78-orientation-explicit-quote
- `Do-not-repeat (next 2 runs):` Q43.S78-orientation-explicit-quote, Q43.S75-orientation-leak-check
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: зафиксировано прямой цитатой, что grid индексируется координатами (i, j) и использует
left/right/up/down + нумерацию строк; значит ориентация — часть модели HR’22, а якорь нужен
только при явной ориентационно‑свободной постановке.
