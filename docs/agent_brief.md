...
- `Do-not-repeat (next 2 runs):` Q43.S178-exp2-quote-scan-remaining, Q43.S179-exp2-quote-scan-analytic
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: аналитические места с `exp(…)` приведены к явному $e^x$ и $\\ln$; следующий шаг — согласовать, где оставлять $\\log_2$ vs $\\ln$ в аналитике.
...
Последние:Эквивалентность→Сжатие/канонизация→Эквивалентность→Сжатие/канонизация→Трейд‑офф
