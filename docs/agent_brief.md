...
- `Do-not-repeat (next 2 runs):` Q43.S180-exp2-quote-scan-logbases, Q43.S181-exp2-quote-scan-logbases-remaining
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в §16.96 PRST'16 лог‑база явно приведена к $\\log_2$ в оценках; следующий шаг — добить оставшиеся $\\log$ в core/summary.
...
Последние:Эквивалентность→Сжатие/канонизация→Трейд‑офф→Эквивалентность→Сжатие/канонизация
