...
- `LastStepID:` Q43.S137-logn-remaining-scan
- `Do-not-repeat (next 2 runs):` Q43.S137-logn-remaining-scan, Q43.S136-logn-occurrence-scan
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: остаточные $\\log N$ в §4 локализованы в Proof of Thm. 4.1 (single‑switching);
следующий шаг — проверить, используется ли Thm. 4.1 как под‑шаг в Thm. 4.3.
...
Последние:Инвариант→Эквивалентность→Инвариант→Эквивалентность→Трейд‑офф
