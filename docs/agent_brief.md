...
- `Do-not-repeat (next 2 runs):` Q39.S68-2k-two-strip-chain-strip-support-rowcol-2d-prefix-global-order-microsteps-alternating-bothstrips-local-block-monotone-2d-strict-prefix, Q43.S208-flat-eval-hr-depth-range
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: диапазон $\\eta$ переписан через $\\kappa$; следующий шаг — извлечь $a,c_1$ для сравнения.
...
- Q43 из `docs/open_questions.md` (вытащить $a,c_1$ и проверить режим $\\kappa$).
...
Последние:Эквивалентность→Коммуникация/ранг→Инвариант→Коммуникация/ранг→Эквивалентность
