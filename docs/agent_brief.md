...
- `Do-not-repeat (next 2 runs):` Q43.S194-flat-eval-axiom-size-model-check, Q43.S195-flat-eval-axiom-size-definition
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: метрика размера закреплена как (N,M); следующий шаг — формализовать в core или Notes.
...
- Q43 из `docs/open_questions.md` (формализовать метрику размера и учёт extension-аксиом).
...
Последние:Инвариант→Трейд-офф→Эквивалентность→Инвариант→Сжатие/канонизация
