...
- `Do-not-repeat (next 2 runs):` Q43.S157-pivot-hastad20-kappa, Q43.S158-largem-branch-polym-check
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: при $\\kappa=59$ порог large‑$M$ субполиномиален ($\\exp=e^x$), так что poly‑$M$ всегда в large‑ветке.
Следующий шаг — перевести оценку Thm. 4.1 в термины $|F|$ и $M=\\mathrm{poly}(|F|)$.
...
- Q43 из `docs/open_questions.md` (перевести оценку Thm. 4.1 в термины $|F|$ и poly‑$M$).
...
Последние:Эквивалентность→Инвариант→Эквивалентность→Трейд‑офф→Эквивалентность
