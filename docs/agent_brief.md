...
- `Do-not-repeat (next 2 runs):` Q43.S162-recount-lemma69-bits, Q43.S163-map-lemma42-a0a1a2
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: источники $A_0,A_1,A_2$ в Proof Lemma 4.2 локализованы; $A_0$ идёт из Lemma 5.5.
Следующий шаг — извлечь явный $A_0$ (или зафиксировать барьер).
...
- Q43 из `docs/open_questions.md` (извлечь явный $A_0$ из Lemma 5.5 или зафиксировать барьер).
...
Последние:Трейд‑офф→Инвариант→Эквивалентность→Инвариант→Эквивалентность
