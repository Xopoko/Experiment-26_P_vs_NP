...
- `Do-not-repeat (next 2 runs):` Q43.S148-thm41-branch-audit, Q43.S149-largem-bound-from-thm41
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: Thm. 4.1 при $\\kappa=59$ даёт лишь субполиномиальный bound $|F|^{o(1)}$;
следующий шаг — сопоставить его с целевыми $N,|F|,M$.
...
- Q43 из `docs/open_questions.md` (сравнение bound Thm. 4.1 с целевыми $N,|F|,M$).
