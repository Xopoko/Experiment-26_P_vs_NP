...
- `LastStepID:` Q39.S47-2k-two-strip-chain-strip-support-global-schedule
- `Do-not-repeat (next 2 runs):` Q43.S190-exp2-quote-scan-logbases-summary-exit, Q39.S47-2k-two-strip-chain-strip-support-global-schedule
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: аудит лог‑баз в summary закрыт; следующий шаг — вернуться к cost‑t evaluations или точке поломки.
Q39: глобальный порядок блоков всё равно даёт ранг 2; следующий шаг — синхронный глобальный шаг по всем колонкам.
...
- Q39 из `docs/open_questions.md` (проверить синхронный глобальный шаг по колонкам для XOR‑шага).
- Q43 из `docs/open_questions.md` (перейти к содержательному шагу: cost‑t evaluations или точка поломки).
...
Последние:Сжатие/канонизация→Эквивалентность→Инвариант→Эквивалентность→Коммуникация/ранг
