...
- `Do-not-repeat (next 2 runs):` Q43.S168-explicit-c-chernoff, Q43.S169-propagate-explicit-a0
- `Last InfoGain:` 1
...
Последние:Инвариант→Коммуникация/ранг→Эквивалентность→Трейд‑офф→Эквивалентность
