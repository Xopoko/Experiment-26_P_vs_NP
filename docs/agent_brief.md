...
- `Do-not-repeat (next 2 runs):` Q43.S163-map-lemma42-a0a1a2, Q43.S164-bound-a0-lemma55
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: получено $A_0=78C$ из Lemma 5.5; остаётся явный $C$.
Следующий шаг — оценить $C$ (или зафиксировать барьер на Chernoff/негативной корреляции).
...
- Q43 из `docs/open_questions.md` (извлечь явный $C$ в Lemma 5.5 или зафиксировать барьер).
