...
- `Do-not-repeat (next 2 runs):` Q43.S192-flat-eval-axiom-size-bound, Q43.S193-flat-eval-axiom-size-accounting
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: accounting зависит от line-size vs line-count; следующий шаг — проверить метрику размера в модели.
...
- Q43 из `docs/open_questions.md` (уточнить метрику размера и статус "free" extension-аксиом).
...
Последние:Коммуникация/ранг→Инвариант→Инвариант→Трейд-офф→Эквивалентность
