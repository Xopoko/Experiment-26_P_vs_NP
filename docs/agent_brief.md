...
- `LastStepID:` Q39.S36-2k-two-strip-equal-rows-single-change
- `Do-not-repeat (next 2 runs):` Q39.S35-2k-two-strip-equal-rows, Q39.S36-2k-two-strip-equal-rows-single-change
- `Last InfoGain:` 1
