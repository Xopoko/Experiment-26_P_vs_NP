...
- `Do-not-repeat (next 2 runs):` Q43.S177-exp2-quote-scan-core, Q43.S178-exp2-quote-scan-remaining
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: core/summary‑формулы приведены к базе $2$; следующий шаг — пройти аналитические места с `exp(…)` и $\\ln$ и явно отметить, где $e^x$.
