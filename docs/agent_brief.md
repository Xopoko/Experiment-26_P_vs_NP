...
Последние: Эквивалентность → Коммуникация/ранг → Сжатие/канонизация → Эквивалентность → Сжатие/канонизация
