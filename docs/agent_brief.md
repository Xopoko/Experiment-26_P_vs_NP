...
- `Do-not-repeat (next 2 runs):` Q43.S198-flat-eval-tparam-usage, Q43.S199-flat-eval-tparam-ologs
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: t привязан к log_2 S; следующий шаг — вывести t=O(log n) при S=poly(n).
...
- Q43 из `docs/open_questions.md` (вывести t=O(log n) из t<=log_2 S).
...
Последние:Сжатие/канонизация→Инвариант→Эквивалентность→Эквивалентность→Эквивалентность
