...
- `Do-not-repeat (next 2 runs):` Q43.S176-exp2-quote-sweep, Q43.S177-exp2-quote-scan-core
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в §16.92 базы $2$ зафиксированы рядом с цитатой Håstad’20; следующий шаг — проверить оставшиеся прямые `exp(…)`‑цитаты в core/summary и явно указать $2^x$ или $e^x$.
...
Последние:Эквивалентность→Сжатие/канонизация→Трейд‑офф→Эквивалентность→Эквивалентность
