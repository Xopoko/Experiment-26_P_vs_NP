...
- `Do-not-repeat (next 2 runs):` Q43.S193-flat-eval-axiom-size-accounting, Q43.S194-flat-eval-axiom-size-model-check
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: HR Theorem 4.3 фиксирует line-size M; следующий шаг — явно закрепить метрику размера в модели.
...
- Q43 из `docs/open_questions.md` (закрепить метрику размера и учёт extension-аксиом).
...
Последние:Инвариант→Инвариант→Трейд-офф→Эквивалентность→Инвариант
