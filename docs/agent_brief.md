...
- `LastStepID:` Q43.S144-translate-largem-vs-polyn
- `Do-not-repeat (next 2 runs):` Q43.S143-translate-n-parameter, Q43.S144-translate-largem-vs-polyn
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: сопоставлены large‑$M$ пороги с poly‑$M$ для $d=\\kappa\\log n/\\log\\log n$; следующий шаг — зафиксировать $\\kappa$.
...
Последние:Инвариант→Трейд‑офф→Трейд‑офф→Эквивалентность→Трейд‑офф
