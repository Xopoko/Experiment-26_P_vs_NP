...
- `Do-not-repeat (next 2 runs):` Q43.S175-exp2-quote-annotation, Q43.S176-exp2-quote-sweep
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: база $2$ для `exp(…)` отмечена рядом с цитатами; следующий шаг — проверить другие разделы на прямые цитаты с `exp(…)` и при необходимости зафиксировать базу $2$.
...
Последние:Сжатие/канонизация→Трейд‑офф→Эквивалентность→Эквивалентность→Сжатие/канонизация
