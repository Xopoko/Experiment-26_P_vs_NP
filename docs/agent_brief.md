...
- `Do-not-repeat (next 2 runs):` Q43.S152-extract-constants, Q43.S153-kappa-constant-derivation
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: явный $\\kappa$ блокируют неявные $A_0,A_1,A_2$ в Proof of Lemma 4.2;
следующий шаг — попытаться извлечь эти константы из Lemma 6.9/6.8.
...
- Q43 из `docs/open_questions.md` (извлечь численные $A_0,A_1,A_2$ для явного $\\kappa$).
...
Последние:Инвариант→Эквивалентность→Инвариант→Инвариант→Трейд‑офф
