...
- `LastStepID:` Q43.S86-admissible-d4-support
- `Do-not-repeat (next 2 runs):` Q43.S84-3bit-upper, Q43.S86-admissible-d4-support
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: D4‑симметричный «крест» из §16.237 не локально согласован (odd‑degree), значит
info‑LB пример не admissible; следующий шаг — найти симметричный допустимый support
