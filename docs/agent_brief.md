...
- `Do-not-repeat (next 2 runs):` Q43.S239-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound-apply-params-poly-n0-monon-log2, Q43.S238-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound-apply-params-poly-n0-monon-grid
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: монотонность log2|F| по n для |F|=n^2 зафиксирована; далее — lift порога от n0 к n>=n0.
