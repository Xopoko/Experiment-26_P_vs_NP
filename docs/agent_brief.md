...
- `LastStepID:` Q39.S19-2k-short-frontier-obstruction
- `Do-not-repeat (next 2 runs):` Q39.S19-2k-short-frontier-obstruction, Q39.S18-2k-staircase-geometry-obstruction
- `Last InfoGain:` 1
...
Q39: контрпример: даже при «коротком фронтире» на $S_j$ (|пересечение|≤2) проекционный ранг
остаётся 2 при $k=2$; следующий шаг — ограничить фронтир до 1.
...
Последние:Инв→МодСтресс→Инв→МодСтресс→Комм/ранг
