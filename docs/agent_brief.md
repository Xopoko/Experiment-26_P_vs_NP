...
- `LastStepID:` Q43.S81-chirality-advice-check
- `Do-not-repeat (next 2 runs):` Q43.S81-chirality-advice-check, Q43.S80-chirality-bit
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: показано, что внешний advice‑бит ориентации $\\chi$ совместим с Remark 6.12 и даёт $O(1)$
overhead; следующий шаг — минимальное число глобальных бит для канонизации ориентации (D4).
