...
- `Do-not-repeat (next 2 runs):` Q43.S196-flat-eval-size-metric-formalize, Q43.S197-flat-eval-size-metric-tparam
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: параметр $t=\\log_2 M$ формализован; следующий шаг — применить t в формулировках Q43.
...
- Q43 из `docs/open_questions.md` (использовать t-параметр в следующем шаге Q43).
...
Последние:Эквивалентность→Инвариант→Сжатие/канонизация→Инвариант→Эквивалентность
