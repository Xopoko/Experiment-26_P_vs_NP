...
- `LastStepID:` Q43.S132-update-summary-dominant-bound
- `Do-not-repeat (next 2 runs):` Q43.S132-update-summary-dominant-bound, Q39.S20-2k-single-frontier-obstruction
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: сводка HR‑режима теперь оставляет единственный $n$‑барьер $n\\ge 20 C n'\\log n'$;
следующий шаг — проверить совместимость остальных предпосылок после $t\\mapsto(2s+1)t$.
Q39: инвариант «единичный фронтир» невозможен уже при $|S_j\\cap\\delta(U_{\\mathrm{root}})|\\ge 3$;
следующий шаг — пробовать ограничение по двум полосам.
...
Последние:Сжатие/канонизация→МодСтресс→Инв→МодСтресс→Комм/ранг
