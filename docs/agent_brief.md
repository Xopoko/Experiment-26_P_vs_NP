...
- `Do-not-repeat (next 2 runs):` Q43.S208-flat-eval-hr-depth-range, Q43.S209-flat-eval-hr-depth-range-constants
- `Last InfoGain:` 1
...
Последние:Эквивалентность→Эквивалентность→Коммуникация/ранг→Инвариант→Коммуникация/ранг
