...
- `LastStepID:` Q43.S134-s1-swap-compatibility
- `Do-not-repeat (next 2 runs):` Q43.S134-s1-swap-compatibility, Q43.S133-hr-compatibility-check
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: замена $s_1=\\log N$ на $\\max\\{\\log N,t'\\}$ совместима с HR‑проверками;
следующий шаг — проверить, нет ли места, где $s_1=\\log N$ используется как равенство.
...
Последние:Эквивалентность→Трейд‑офф→Сжатие/канонизация→МодСтресс→Инв
