...
- `LastStepID:` Q39.S8-generalize-block-invariant
- `Do-not-repeat (next 2 runs):` Q39.S8-generalize-block-invariant, Q43.S83-d4-lower-bound
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: D4‑симметричный support даёт lower bound ≥3 глобальных бит для ориентации; следующий
шаг — 3‑битная канонизация, совместимая с Algorithms 2–4.
