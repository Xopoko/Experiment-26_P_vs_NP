...
- `Do-not-repeat (next 2 runs):` Q43.S199-flat-eval-tparam-ologs, Q43.S200-flat-eval-tparam-ologn
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: t сведён к O(log_2 n) при poly-size; следующий шаг — оформить явный режим polylog.
...
- Q43 из `docs/open_questions.md` (зафиксировать polylog режим для t).
...
Последние:Инвариант→Эквивалентность→Эквивалентность→Эквивалентность→Трейд-офф
