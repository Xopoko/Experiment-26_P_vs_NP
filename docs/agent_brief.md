...
- `LastStepID:` Q39.S23-2k-two-strip-rank-toy
- `Do-not-repeat (next 2 runs):` Q39.S23-2k-two-strip-rank-toy, Q39.S22-2k-two-strip-frontier-obstruction
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: следующий шаг прежний (Thm. 4.1 → Thm. 4.3).
Q39: toy‑контрпример для двух полос (ранг = 2 при k=2); следующий шаг — интервальность/структура.
...
Последние:Трейд‑офф→Инвариант→Двойственность→Инвариант→Коммуникация/ранг
