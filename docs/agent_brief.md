...
- `LastStepID:` Q43.S122-quotient-sufficiency-proof
- `Do-not-repeat (next 2 runs):` Q43.S121-mixed-edge-quotient-linear-criterion, Q43.S122-quotient-sufficiency-proof
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: доказано, что в каноническом режиме $A x=\\mathbf 1\\Leftrightarrow B_{G/\\pi}x=b_{\\mathrm{mix}}$;
следующий шаг — стресс‑тестировать критерий вне канонического режима или уточнить
дополнительные линейные условия.
...
Последние:МодСтресс→Инв→Комм/Ранг→Эквивалентность→Эквивалентность
