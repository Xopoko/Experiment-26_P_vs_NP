...
- `LastStepID:` Q39.S35-2k-two-strip-equal-rows
- `Do-not-repeat (next 2 runs):` Q39.S34-2k-two-strip-laminar-rows, Q39.S35-2k-two-strip-equal-rows
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: равенство строк на двух полосах не снижает ранг; следующий шаг — равные строки + одно‑строчное изменение.
...
Последние:Трейд‑офф→Коммуникация/ранг→Инвариант→Трейд‑офф→Коммуникация/ранг
