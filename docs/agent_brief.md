...
Proof complexity → Tseitin как тест‑кейс: после $\\mathrm{wb}(G^*)=\\mathrm{cw}(G)$ (16.105) проверить утверждение AR’11 Remark 2.11 про «повторы гиперрёбер не меняют $\\mathrm{wb}$» (Q24).
...
- Q24 из `docs/open_questions.md` (обновлять там же, но без раздувания).
