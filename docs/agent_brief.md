...
- `LastStepID:` Q43.S145-kappa-regime-decision
- `Do-not-repeat (next 2 runs):` Q43.S144-translate-largem-vs-polyn, Q43.S145-kappa-regime-decision
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: зафиксирован режим $\\kappa\\ge 1$ ⇒ poly‑$M$ в large‑$M$ ветке; следующий шаг — подтвердить $\\kappa$ из источника.
...
Последние:Трейд‑офф→Трейд‑офф→Эквивалентность→Трейд‑офф→Инвариант
