...
- `LastStepID:` Q43.S64-absorb-a2-by-signature
- `Do-not-repeat (next 2 runs):` Q43.S64-absorb-a2-by-signature, Q43.S63-bound-a2-graph-structure
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: подписи не фиксируют структуру $I_j$ (A2 не поглощается); далее проверить, можно ли
константно расширить подпись, чтобы кодировать $I_j$ без ухудшения оценки.
