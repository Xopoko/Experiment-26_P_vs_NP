...
- `Do-not-repeat (next 2 runs):` Q43.S182-exp2-quote-scan-logbases-core-sweep, Q43.S183-exp2-quote-scan-logbases-summary-sweep
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в summary `docs/15_proof_complexity.md` лог‑база приведена к $\\log_2$; следующий шаг — добить оставшиеся $\\log$ в summary вне §15.
...
Последние:Трейд‑офф→Эквивалентность→Сжатие/канонизация→Эквивалентность→Сжатие/канонизация
