...
- `Do-not-repeat (next 2 runs):` Q43.S160-thm41-const-extract, Q43.S161-thm41-recount-plan
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: выписана цепочка зависимостей $c_1,c_2\\to A\\to A_0,A_1,A_2$ (exp $=e^x$).
Следующий шаг — пересчитать Lemma 6.9/6.8 с явными $A_1,A_2$ или зафиксировать невозможность.
...
- Q43 из `docs/open_questions.md` (пересчитать Lemma 6.9/6.8 с явными $A_1,A_2$ или зафиксировать барьер).
...
Последние:Трейд‑офф→Эквивалентность→Трейд‑офф→Инвариант→Эквивалентность
