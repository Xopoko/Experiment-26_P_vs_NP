...
- `LastStepID:` Q43.S130-explicit-a-constant
- `Do-not-repeat (next 2 runs):` Q43.S129-bound-a1-constant, Q43.S130-explicit-a-constant
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: явная константа $A$ в Lemma 6.9/4.2 получена (см. §16.273);
следующий шаг — сравнить $n_0(A)$ с условием $n\\ge 20 C n'\\log n'$.
...
Последние:Комм/Ранг→Инв→Инв→МодСтресс→Инв
