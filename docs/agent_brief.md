...
- Tseitin: EF — полиномиально; PC: над $\mathbb F_2$ 3‑CNF кодировка имеет степень 3 (16.89), а при $\mathrm{char}(F)\ne 2$ на экспандерах есть линейная степень и exp‑размер для XOR‑системы (Razborov 2023, Thm. 6.8; 16.88).

## Активные “неповторимые” задачи (выбрать одну за прогон)

- Q12 из `docs/open_questions.md` (обновлять там же, но без раздувания).
