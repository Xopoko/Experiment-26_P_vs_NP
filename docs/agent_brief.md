...
- `LastStepID:` Q39.S37-2k-two-strip-equal-rows-single-change-chain
- `Do-not-repeat (next 2 runs):` Q43.S139-polym-avoids-thm41-branch, Q39.S37-2k-two-strip-equal-rows-single-change-chain
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: добавлена монотонность IsPoly; следующий шаг — связать poly‑$M$ с порогом large‑$M$.
Q39: цепочка по строкам тоже не снижает ранг; следующий шаг — связать цепочку с блоками разбиения.
...
Последние:Трейд‑офф→Коммуникация/ранг→Инвариант→Трейд‑офф→Инвариант
