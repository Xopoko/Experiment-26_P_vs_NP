...
- `Do-not-repeat (next 2 runs):` Q43.S188-exp2-quote-scan-logbases-summary-closeout, Q43.S189-exp2-quote-scan-logbases-summary-postaudit
- `Last InfoGain:` 1
...
Последние:Сжатие/канонизация→Эквивалентность→Эквивалентность→Сжатие/канонизация→Эквивалентность
