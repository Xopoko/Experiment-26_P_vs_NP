...
- `Do-not-repeat (next 2 runs):` Q39.S45-2k-two-strip-chain-dyadic-microsteps-strip-support, Q43.S170-explicit-c1c2-thm41
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: явные $c_1,c_2$ выписаны; следующий шаг — проверить порог $M>e^{n^\alpha}$ и базу логарифма.
...
- Q43 из `docs/open_questions.md` (проверить порог $M>e^{n^\alpha}$ и базу логарифма в Q43).
...
Последние:Коммуникация/ранг→Инвариант→Трейд‑офф→Инвариант→Эквивалентность
