...
- `LastStepID:` Q43.S84-3bit-upper
- `Do-not-repeat (next 2 runs):` Q43.S83-d4-lower-bound, Q43.S84-3bit-upper
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: 3‑битная канонизация ориентации через global advice построена; следующий шаг —
проверить anchor‑канонизацию из support+подписей или локальный impossibility.
