...
- `Do-not-repeat (next 2 runs):` Q39.S46-2k-two-strip-chain-strip-support-synchronized, Q43.S190-exp2-quote-scan-logbases-summary-exit
- `Last InfoGain:` 1
...
Последние:Эквивалентность→Сжатие/канонизация→Эквивалентность→Инвариант→Эквивалентность
