...
- `LastStepID:` Q43.S75-orientation-leak-check
- `Do-not-repeat (next 2 runs):` Q43.S75-orientation-leak-check, Q43.S74-dir-rule-chord-bits
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: подтверждено, что фиксированная ориентация уже заложена в подписи (Def. 6.11),
поэтому South/West‑правило не даёт identity‑leak; дальше — якорь только если нужна
ориентация‑свободная модель.
