...
- `Do-not-repeat (next 2 runs):` Q43.S183-exp2-quote-scan-logbases-summary-sweep, Q43.S184-exp2-quote-scan-logbases-summary-remaining
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: в summary `docs/11_switching_lemma_ac0.md` лог‑база приведена к $\\log_2$; следующий шаг — добить оставшиеся $\\log$ в summary вне §15/§11.
...
Последние:Эквивалентность→Сжатие/канонизация→Эквивалентность→Сжатие/канонизация→Эквивалентность
