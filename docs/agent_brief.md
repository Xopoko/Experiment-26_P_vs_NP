...
- `Do-not-repeat (next 2 runs):` Q43.S164-bound-a0-lemma55, Q43.S165-bound-c-lemma55
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: $C$ в Lemma 5.5 остаётся неявной Chernoff‑константой; $A_0$ численно не фиксируется.
Следующий шаг — пересчитать Chernoff‑шаги с явными константами или заморозить $A_0$.
Q39: блок‑согласованная цепочка тоже не снижает ранг; следующий шаг — усилить совместимость с границами блоков.
...
- Q43 из `docs/open_questions.md` (пересчитать Chernoff‑шаги с явными константами или зафиксировать барьер).
...
Последние:Эквивалентность→Инвариант→Эквивалентность→Инвариант→Инвариант
