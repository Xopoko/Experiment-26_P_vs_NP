...
- `LastStepID:` Q43.S13-tightness-regime
- `Do-not-repeat (next 2 runs):` Q43.S13-tightness-regime, Q43.S12-corollary-thm43-flat-local-ef
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: выведен критерий $N\\ge\\exp(n^{1-o(1)})$; дальше — порог по $s$ в условии $(*)$.
...
Последние: Инвариант → Эквивалентность → Инвариант → Трейд‑офф → Инвариант
