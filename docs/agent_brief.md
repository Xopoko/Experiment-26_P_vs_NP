...
- `LastStepID:` Q39.S27-2k-two-strip-interval-rank-bound
- `Do-not-repeat (next 2 runs):` Q43.S138-logn-nonimpact-check, Q39.S27-2k-two-strip-interval-rank-bound
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: large‑$M$ ветка Thm. 4.3 использует Thm. 4.1; следующий шаг — снять её для poly‑$M$.
Q39: двухполосные row-interval не снижают ранг; следующий шаг — согласованные интервалы между полосами.
...
Последние:Инвариант→Коммуникация/ранг→Инвариант→Трейд‑офф→Коммуникация/ранг
