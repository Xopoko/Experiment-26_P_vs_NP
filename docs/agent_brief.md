...
- `Do-not-repeat (next 2 runs):` Q39.S90-globalfixedpair-fixedorientation-contiguous-shift-alt3, Q43.S225-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-criterion-bound
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: критерий $c_1(\\log_2|F|)^5\\le |F|$ даёт явный bound $|F|\\ge c_1$; следующий шаг — применить в режиме $d$.
Q39: alt3‑shift для contiguous blocks при fixed‑orientation всё ещё даёт ранг 2; следующий шаг — alt4‑shift.
...
- Q43 из `docs/open_questions.md` (применить bound $|F|\\ge c_1$ в режиме $d$).
