...
- `Do-not-repeat (next 2 runs):` Q43.S153-kappa-constant-derivation, Q43.S154-lemma42-constants-extract
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: извлечены явные $s/64\\le a$ и $b\\le 3a$, но $A$ в Lemma 6.9 остаётся неявным;
...
- Q43 из `docs/open_questions.md` (попытаться оценить $A$ из Proof of Lemma 6.9).
