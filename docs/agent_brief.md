...
- `LastStepID:` Q39.S17-2k-rectangular-geometry-obstruction
- `Do-not-repeat (next 2 runs):` Q39.S17-2k-rectangular-geometry-obstruction, Q39.S16-2k-monotone-geometry-obstruction
- `Last InfoGain:` 1
...
Q39: контрпример: даже при прямоугольной геометрии внутренних узлов проекционный ранг остаётся 2
при $k=2$; следующий шаг — усилить геометрию (ступенчатые/anchored области).
...
Последние:Экв→Комм/ранг→Инв→МодСтресс→Инв
