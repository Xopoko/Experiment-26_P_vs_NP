...
- `LastStepID:` Q44.S1-drop-legacy-checks
- `Do-not-repeat (next 2 runs):` Q44.S1-drop-legacy-checks, Q43.S137-logn-remaining-scan
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Infra: удалён legacy‑контур notebook‑проверок; Q43 следующий шаг прежний (Thm. 4.1 → Thm. 4.3).
...
Последние:Эквивалентность→Инвариант→Эквивалентность→Трейд‑офф→Инвариант
