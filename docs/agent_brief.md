...
- `LastStepID:` Q43.S88-quotient-parity
- `Do-not-repeat (next 2 runs):` Q43.S87-fixed-center-parity, Q43.S88-quotient-parity
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: D4‑квотиент по орбитным рёбрам слишком сильный (2×2 support даёт odd‑degree matching),
следующий шаг — проверка orbit‑8‑only supports или локальная обструкция (Q43.S89).
