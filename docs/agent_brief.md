...
- `LastStepID:` Q43.S124-extra-nn-edge-constraint
- `Do-not-repeat (next 2 runs):` Q43.S122-quotient-sufficiency-proof, Q43.S124-extra-nn-edge-constraint
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑тест с двумя π‑звёздами + extra non‑chosen edge дал $e=0$ и не сломал
квотиентный критерий; следующий шаг — проверить случай с циклом в $G/\\pi$.
