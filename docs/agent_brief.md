...
- `Do-not-repeat (next 2 runs):` Q43.S167-freeze-a0-parameter, Q43.S168-explicit-c-chernoff
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: явный $C$ получен; следующий шаг — протащить $A_0=78C$ в Lemma 4.2/Thm. 4.1.
...
Последние:Эквивалентность→Инвариант→Коммуникация/ранг→Эквивалентность→Трейд‑офф
