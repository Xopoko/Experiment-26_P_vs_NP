...
- `LastStepID:` Q39.S10-block-parity-invariant
- `Do-not-repeat (next 2 runs):` Q39.S10-block-parity-invariant, Q43.S111-size4-pi-obstruction
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑тест с двумя π‑звёздами размера 4 совместим с запретом chosen–non‑chosen;
следующий шаг — обобщить совместимость/критерий через $G/\\pi$.
...
Последние:Инв→Комм/Ранг→Инв→Инв→Инв
