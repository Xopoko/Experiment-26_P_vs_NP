...
- `LastStepID:` Q43.S108-odd-pi-component-parity
- `Do-not-repeat (next 2 runs):` Q43.S108-odd-pi-component-parity, Q43.S107-pi-quotient-counterexample-def6-2-4
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: нечётная non‑chosen π‑компонента даёт паритетный конфликт, но такой компонент
невозможен (Def. 5.2: размер 2 или 4); следующий шаг — проверить две π‑компоненты
или попробовать лемму о декуплинге.
...
Последние:Инв→Инв→Мод→Инв→Комм/Ранг
