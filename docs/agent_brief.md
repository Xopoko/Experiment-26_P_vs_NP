...
- `Do-not-repeat (next 2 runs):` Q43.S222-flat-eval-hr-depth-range-constants-a0-c1c2-log2-verify-regime-d-asymptotic-apply, Q39.S86-globalfixedpair-fixedorientation-contiguous
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: эквивалентность порога без деления для $n\\ge2$; следующий шаг — критерий в режиме $d$ для |F|.
Q39: contiguous blocks при fixed‑orientation всё ещё дают ранг 2; следующий шаг — contiguous blocks с фиксированным сдвигом.
...
- Q39 из `docs/open_questions.md` (contiguous blocks с фиксированным сдвигом).
