...
- `Do-not-repeat (next 2 runs):` Q43.S349-band-log2-setup-bundle, Q39.S145-merge-q39-notes
- `Last InfoGain:` 0
...
Q39: BLOCKED by entropy stopper; resume at Q39.S146-contiguous-alt-rank2-classify-or-barrier. Q43: BLOCKED by entropy stopper; resume at Q43.S350-band-log2-setup-bundle.
...
- Q43 from `docs/open_questions.md` (blocked; resume at Q43.S350-band-log2-setup-bundle).
