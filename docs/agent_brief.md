...
- `LastStepID:` Q43.S141-poly-vs-exp-threshold
- `Do-not-repeat (next 2 runs):` Q39.S38-2k-two-strip-chain-block-alignment, Q43.S141-poly-vs-exp-threshold
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: toy‑чек показывает, что poly‑$M$ не автоматически ниже large‑$M$; следующий шаг — явный мэппинг параметров HR.
...
Последние:Трейд‑офф→Инвариант→Трейд‑офф→Инвариант→Трейд‑офф
