...
- `Do-not-repeat (next 2 runs):` Q43.S159-thm41-bound-translate, Q43.S160-thm41-const-extract
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: константы $c_1,c_2$ в Proof Thm. 4.1 остаются нечисловыми ($\\exp=e^x$).
Следующий шаг — либо план пересчёта Proof Thm. 4.1, либо смена режима/источника.
...
- Q43 из `docs/open_questions.md` (выбрать: пересчёт Proof Thm. 4.1 или смена режима/источника).
...
Последние:Эквивалентность→Трейд‑офф→Эквивалентность→Трейд‑офф→Инвариант
