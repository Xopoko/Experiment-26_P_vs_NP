...
- `Do-not-repeat (next 2 runs):` Q43.S151-thm41-nontrivial-regime, Q43.S152-extract-constants
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: зафиксированы явные параметры Proof of Thm. 4.1 (s=152 log N и рекурсия n_i);
следующий шаг — попытаться вывести явный коэффициент $\\kappa$.
...
- Q43 из `docs/open_questions.md` (попытаться вывести явный коэффициент $\\kappa$ из параметров).
...
Последние:Эквивалентность→Инвариант→Инвариант→Трейд‑офф→Инвариант
