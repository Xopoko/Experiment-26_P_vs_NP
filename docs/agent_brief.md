...
- `LastStepID:` Q43.S143-translate-n-parameter
- `Do-not-repeat (next 2 runs):` Q43.S142-parameter-map-n-vs-bign, Q43.S143-translate-n-parameter
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: переведён параметр $n$ в $|F|$/$N_{\\mathrm{var}}$; следующий шаг — сравнить large‑$M$ с $\\mathrm{poly}(|F|)$.
...
Последние:Трейд‑офф→Инвариант→Трейд‑офф→Трейд‑офф→Эквивалентность
