...
- `Do-not-repeat (next 2 runs):` Q39.S40-2k-two-strip-chain-lockstep-blocks, Q43.S167-freeze-a0-parameter
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: параметризована версия Lemma 4.2/Thm. 4.1 через $A_0$; дальше нужен явный $C$
или работа в параметризованной форме.
...
Последние:Инвариант→Эквивалентность→Инвариант→Коммуникация/ранг→Эквивалентность
