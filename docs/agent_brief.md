...
- `LastStepID:` Q39.S54-2k-two-strip-chain-strip-support-rowcol-2d-prefix-lockstep
- `Do-not-repeat (next 2 runs):` Q43.S201-flat-eval-tparam-polylogn, Q39.S54-2k-two-strip-chain-strip-support-rowcol-2d-prefix-lockstep
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: t сведён к polylog n при quasi-poly size; следующий шаг — проверить HR-совместимость.
Q39: глобальный 2D‑prefix lock‑step всё равно даёт ранг 2; следующий шаг — глобальный порядок блоков.
...
- Q39 из `docs/open_questions.md` (проверить глобальный порядок блоков для row/col 2D‑prefix).
...
Последние:Эквивалентность→Эквивалентность→Трейд-офф→Эквивалентность→Инвариант
