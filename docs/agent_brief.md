...
- `Do-not-repeat (next 2 runs):` Q43.S150-thm41-bound-compare, Q43.S151-thm41-nontrivial-regime
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: для $\\kappa<1/5$ нужен явный коэффициент в $O(\\log n/\\log\\log n)$; без него —
локальный барьер. Следующий шаг — извлечь константы из Lemma 4.2/Thm. 4.1.
...
- Q43 из `docs/open_questions.md` (вытащить явные константы, чтобы проверить режим $\\kappa<1/5$).
...
Последние:Инвариант→Инвариант→Трейд‑офф→Инвариант→Эквивалентность
