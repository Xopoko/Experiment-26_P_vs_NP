...
- `LastStepID:` Q43.S69-encode-cycle-basis-bits
- `Do-not-repeat (next 2 runs):` Q43.S69-encode-cycle-basis-bits, Q43.S68-tree-uniqueness-cycle-bit
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: показано, что $I_j$ кодируется базисом циклов через канонический остов и ≤4 бит на центр;
дальше проверить совместимость с подписями Def. 6.11/6.13 и Algorithms 2–4.
