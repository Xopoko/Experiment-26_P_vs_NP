...
- `LastStepID:` Q43.S120-even-mixed-edge-counterexample
- `Do-not-repeat (next 2 runs):` Q43.S118-mixed-edge-parity-invariant, Q43.S120-even-mixed-edge-counterexample
- `Last InfoGain:` 1

## Текущее направление (держать 1–2 строки)

Q43: контрпример — чётность mixed‑edges на π‑компоненте недостаточна (две mixed‑edges
к одному chosen‑центру дают конфликт); следующий шаг — критерий на квотиенте с
учётом chosen‑вершин.
