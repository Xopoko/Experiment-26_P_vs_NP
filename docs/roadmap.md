...
- **F2 (in progress):** CNF/3CNF syntax and SAT in `formal/PvNP/SAT.lean`; graph/clique skeleton in `formal/PvNP/Graph.lean`; reduction interfaces in `formal/PvNP/ReductionsSAT.lean` (proofs pending).
