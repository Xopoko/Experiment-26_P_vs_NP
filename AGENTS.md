...
1) Сформулируй конкретный вопрос уровня “А что если…?” как лемму/конъектуру (с чёткими предпосылками/выводом).
...
4) В `P_vs_NP.ipynb` записывай только **новое математическое содержание** (лемма/контрпример/барьер/чек‑лист следующего шага); косметические правки без нового результата — запрещены.
5) Все длинные “исследовательские шаги” (16.x‑стиля) пиши в `notebooks/16_research_steps.ipynb`; в `P_vs_NP.ipynb` оставляй только краткий итог и ссылку.
